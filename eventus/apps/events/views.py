...
class MainPanelView(TemplateView):
	...
	def get_context_data(self, **kwargs):
	    ...
	    context['events'] = Event.objects.filter(organizer = self.request.user ).order_by('is_free', '-created')	   	#context['events']=Event.objects.filter(organizer__username='victorvillazon').order_by('is_free','-created')
...
class CreateEvent(CreateView):
	...
	def form_valid(self,form):
		...
		#aqui le pasamos sel por que es la variable a majnejar en este momento
